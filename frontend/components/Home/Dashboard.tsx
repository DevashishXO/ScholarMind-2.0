      ...
      <div className="max-w-screen mx-auto px-6 py-10">
        ...
        <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 bg-[rgba(255,255,255,0.04)] cursor-pointer border border-white/6 backdrop-blur-md px-4 py-2 rounded-lg hover:scale-[1.02] transition">
              <PlusCircle size={18} className="text-[var(--color-orange)]" />
              <span className="text-sm font-bungee">New Research</span>
            </button>

            <button className="bg-[var(--color-orange)] font-bungee text-white cursor-pointer px-4 py-2 rounded-lg font-semibold hover:brightness-95 transition">
              Quick Start
            </button>
          </div>
        </header>
